...
const initPay=(order)=>{
        const option={
          key:import.meta.env.VITE_RAZOROAY_KEY_ID,
          amount:order.amount,
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            <button type='submit' className='border bg-black text-white px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </form>
